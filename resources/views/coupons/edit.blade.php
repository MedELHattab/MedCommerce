...
@section('content')
    ...
    <div class="lg:px-10">
        ...
        <form class="max-w-sm mx-auto" action="{{ route('coupons.update', $coupon) }}" method="post"
            ...
            <div class="mb-5">
                ...
                <input type="number" name="percentage_discount"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    value="{{ old('percentage_discount', $coupon->percentage_discount) }}">

            </div>

            <div class="mb-5">
                <label for="usage_limit"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Usage Limit</label>
